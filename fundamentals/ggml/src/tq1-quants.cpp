...
int main(int argc, char **argv) {
    ...
    ggml_quantize_init(GGML_TYPE_TQ1_0);
    ...
    size_t dst_size = ggml_row_size(GGML_TYPE_TQ1_0, 256) * 1;
    std::vector<uint8_t> dst(dst_size);

    auto ret = ggml_quantize_chunk(GGML_TYPE_TQ1_0, src, dst.data(), 0, 1, 256, nullptr);
