...
There annotated data sets like [Coco](https://cocodataset.org/) where humans
...
Now, using training the input data set consists of pairs of images and text
inputs. At inference time there might not be any text, we could just pass and
